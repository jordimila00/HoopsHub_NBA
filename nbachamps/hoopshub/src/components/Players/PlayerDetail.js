...
function PlayerDetail() {
  ...
  return (
    <div className='mt-2 flex'>
      <div className="p-6 w-80 cursor-pointer rounded-3xl bg-gray-100 transition duration-300 ease-in-out hover:scale-105 hover:drop-shadow-2xl">
      ...
      <div className="ml-6 mt-32 w-full">
  <h4 className="text-xl font-bold mb-4 text-gray-800">AVERAGE FINALS</h4>
  <div className="overflow-x-auto">
    <table className="min-w-full bg-white border border-gray-200">
      <thead>
        <tr className="bg-gray-100">
          <th className="px-4 py-2 text-left text-sm font-bold text-gray-700 uppercase tracking-wider">Year</th>
          <th className="px-4 py-2 text-left text-sm font-bold text-gray-700 uppercase tracking-wider">Team</th>
          <th className="px-4 py-2 text-left text-sm font-bold text-gray-700 uppercase tracking-wider">No</th>
          <th className="px-4 py-2 text-left text-sm font-bold text-gray-700 uppercase tracking-wider">GP</th>
          <th className="px-4 py-2 text-left text-sm font-bold text-gray-700 uppercase tracking-wider">MPG</th>
          <th className="px-4 py-2 text-left text-sm font-bold text-gray-700 uppercase tracking-wider">PPG</th>
          <th className="px-4 py-2 text-left text-sm font-bold text-gray-700 uppercase tracking-wider">RPG</th>
          <th className="px-4 py-2 text-left text-sm font-bold text-gray-700 uppercase tracking-wider">APG</th>
          <th className="px-4 py-2 text-left text-sm font-bold text-gray-700 uppercase tracking-wider">SPG</th>
          <th className="px-4 py-2 text-left text-sm font-bold text-gray-700 uppercase tracking-wider">BPG</th>
          <th className="px-4 py-2 text-left text-sm font-bold text-gray-700 uppercase tracking-wider">FG%</th>
          <th className="px-4 py-2 text-left text-sm font-bold text-gray-700 uppercase tracking-wider">3P%</th>
        </tr>
      </thead>
      <tbody>
        {matches.map(match => (
